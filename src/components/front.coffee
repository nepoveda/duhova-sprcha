      ...
      <Grid className="pages">
        <Row className="row-centered">
          <Col xs={6} md={3} className="col-centered">
            ...
            <Thumbnail src="/assets/images/text-terapie-pastelkou.png" alt="terapie-pastelkou" onClick={->props.onSetScreen('terapie-pastelkou')} />
          </Col>
          <Col xs={6} md={3} className="col-centered">
            <Thumbnail src="/assets/images/bublina-masaze.png" alt="masaze" onClick={->props.onSetScreen('masaze')} />
          ...
          <Col xs={6} md={3} className="col-centered">
            ...
            <Thumbnail src="/assets/images/text-energeticke-cisteni-prostor.png" alt="energeticke-cisteni-prostor" onClick={->props.onSetScreen('energeticke-cisteni-prostor')} />
          </Col>
        </Row>
        <Row className="row-centered">
            <Col xs={6} md={3} className="col-centered">
            ...
            <Col xs={6} md={3} className="col-centered">
              ...
              <Thumbnail src="/assets/images/text-kontakt.png" alt="kontakt" onClick={->props.onSetScreen('kontakt')} />
            </Col>
        </Row>
      </Grid>
    </div>
